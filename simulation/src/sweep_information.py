"""Sweep: 2x2 information factorial (history x resource visibility), 30 agents spatial."""
import sys
...
conditions = [
    {"label": "hist_vis",   "history_length": 10, "hide_resources": False},
    {"label": "hist_hid",   "history_length": 10, "hide_resources": True},
    {"label": "nohist_vis", "history_length": 0,  "hide_resources": False},
    {"label": "nohist_hid", "history_length": 0,  "hide_resources": True},
]

print("=== INFORMATION 2x2 FACTORIAL SWEEP (30 agents, spatial) ===")
for cond in conditions:
    for rep in range(1, 3):
        params = {**base_params, "history_length": cond["history_length"]}
        ...
        run_id = f"info_{cond['label']}_rep{rep}"
        print(f"\n=== {cond['label']} (history={cond['history_length']}, hide_resources={cond['hide_resources']}), rep={rep} ===")
