#!/bin/bash
#SBATCH --job-name=night30x30
#SBATCH --partition=gpu_h100
#SBATCH --nodes=1
#SBATCH --gpus-per-node=1
#SBATCH --time=02:30:00
#SBATCH --cpus-per-task=4
#SBATCH --output=logs/night30x30_%j.out
#SBATCH --error=logs/night30x30_%j.err

# 30 agents × 30 rounds, L2 ToM + DM + rewiring w=0.3
# Qwen 3.5-27B via vLLM nightly.
...
API_CONFIG=config/vllm_config.yaml

echo "=== NIGHT RUN: 30 agents × 30 rounds ==="
