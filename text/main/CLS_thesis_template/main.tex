...
\input{Chapters/3_Methods}                    % Ch 3: Game design, agent architecture + model selection, IVs, experimental design, metrics, infrastructure (12-17 pages)
% NOTE: Former Ch 4 (Model Selection & Infrastructure) merged into Ch 3 §3.2 and §3.6.
% File 4_ModelAndInfrastructure.tex kept for reference but no longer included.
\input{Chapters/5_Results}                    % Ch 4: OAT sweeps, reasoning/info/comm effects (10-15 pages)
\input{Chapters/6_Validation}                 % Ch 5: Trace analysis, faithfulness, K-level verification (5-8 pages)
\input{Chapters/7_Discussion}                 % Ch 6: Interpretation, Hobbesian Trap, limitations (5-8 pages)
\input{Chapters/8_Conclusion}                 % Ch 7: Answers to RQs, contributions, future work (3-5 pages)
...
%\input{Appendices/AppendixPrompts}    % Full prompt texts for L0-L3
%\input{Appendices/AppendixA}          % Additional tables/figures
