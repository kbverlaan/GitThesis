...
%
%   NOTE: Pre-experiment prompt optimization via TextGrad is described in
%   §3.2.2 (Prompt Structure). TextGrad optimized for instruction CLARITY
%   (not reasoning depth), using Claude Opus as evaluator with level-specific
%   rubrics. This subsection tests post-optimization ROBUSTNESS: do
%   semantically equivalent reformulations of the optimized prompts produce
%   consistent results? This is a separate question from clarity optimization.
